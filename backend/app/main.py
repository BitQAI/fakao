...
from app.routers import (assistant, audio, cards, case_library, coverage, import_,
                         marks, plans, quizzes, reports, reviews, settings, source,
...
for router in (today.router, plans.router, reviews.router, audio.router,
               ...
               statutes.router, cards.router, case_library.router, cases_quiz.router):
